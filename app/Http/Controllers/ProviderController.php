...
class ProviderController extends Controller {
    ...
    public function store(UserRequest $request) {
        ...
        // Handle custom commission validation
        if (!empty($data['custom_commission_type']) || !empty($data['custom_commission_value'])) {
            $request->validate([
                'custom_commission_type' => 'required|in:percentage,fixed',
                'custom_commission_value' => 'required|numeric|min:0|max:999999'
            ]);
        } else {
            // Clear custom commission if both fields are empty
            $data['custom_commission_type'] = null;
            $data['custom_commission_value'] = null;
        }
