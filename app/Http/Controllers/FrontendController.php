...
class FrontendController extends Controller {
    ...
    public function cookiePolicy(Request $request) {
        $cookie_policy = Setting::where('type', 'cookie_policy')->where('key', 'cookie_policy')->first();
        return view('landing-page.cookiePolicy', compact('cookie_policy'));
    }

    public function paymentPolicy(Request $request) {
        $payment_policy = Setting::where('type', 'payment_policy')->where('key', 'payment_policy')->first();
        return view('landing-page.paymentPolicy', compact('payment_policy'));
    }
