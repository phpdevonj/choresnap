    ...
    public function index_data(DataTables $datatable, Request $request) {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('user_type', function ($query) {
                return $query->user_type === 'user' ? 'customer' : $query->user_type;
            })
        ...
        if ($request->list_status !== 'unverified') {
            ...
            $datatable->addColumn('is_email_verified_status', function ($row) {
                return $row->is_email_verified ? 'Yes' : 'No';
            });
        ...
        $datatable->addIndexColumn()
            ->rawColumns(['check', 'display_name', 'action', 'status', 'is_email_verified', 'is_email_verified_status']);
