...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
                'username'          => 'required|max:255|unique:users,username,'.$id.',id,user_type,'.$this->user_type,
                'email'             => 'required|email|max:255|unique:users,email,'.$id.',id,user_type,'.$this->user_type,
