...
class UserFavouriteResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'provider_image'=> (optional($this->service->providers)->login_type != null && optional($this->service->providers)->social_image != null) ? optional($this->service->providers)->social_image : getSingleMedia(optional($this->service->providers), 'profile_image',null),
