        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold">{{ !empty($data['dashboard']['count_last3DaysUsers']) ? $data['dashboard']['count_last3DaysUsers']: 0 }} </h4>
                                                <!-- <h4 class="mb-2 booking-text  font-weight-bold text-break"> 000000000000 </h4> -->
                                            </div>
                                            <p class="mb-0 booking-text">{{ __('messages.users_last_3_days') }}</p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text">{{ __('messages.services') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text">{{ __('messages.providers') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon iq-card-icon-provider icon-shape  text-white rounded-circle shadow">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text">{{ __('messages.revenue') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                            ...
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ $data['dashboard']['count_total_booking'] }}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text">{{ __('messages.bookings').' '. __('messages.received') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon iq-card-icon-revenue icon-shape text-white rounded-circle shadow">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('booking.index',['filter[column_status]' => 'accept']) }}">
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ $data['dashboard']['count_total_accept_booking'] }}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text">{{ __('messages.bookings').' '. __('messages.accepted') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon iq-card-icon-revenue icon-shape text-white rounded-circle shadow">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('booking.index', ['filter[column_status]' => 'cancelled']) }}">
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ $data['dashboard']['count_total_cancelled_booking'] }}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text" >{{ __('messages.bookings').' '. __('messages.cancelled',['name' => '']) }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon iq-card-icon-revenue icon-shape text-white rounded-circle shadow">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('booking.index', ['filter[column_status]' =>  'completed']) }}">
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ $data['dashboard']['count_total_completed_booking'] }}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text" >{{ __('messages.bookings').' '. __('messages.completed') }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon iq-card-icon-revenue icon-shape text-white rounded-circle shadow">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <h4 class="revenue_heading">{{__('messages.monthly_revenue')}}</h4>
                            <div class="d-flex align-items-center gap-2">
                                <select id="revenue-period" class="form-control" style="width: auto;">
                                    <option value="month" selected>This Month</option>
                                    <option value="year" >This Year</option>
                                    <option value="custom">Custom Date</option>
                                </select>
                                <input type="text" id="date-range" class="form-control d-none" placeholder="Select date range">
                            </div>
                        </div>
                        ...
                        <ul class="common-list p-0">
                            ...
                            @foreach($data['dashboard']['upcomming_booking'] as $booking)
                                <li class="d-flex flex-wrap gap-2 align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row "
                                    ...
                                    <span
                                        class="badge rounded-pill py-2 px-3 badge-pending text-capitalize">{{$booking->status}}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
...
<script>
    ...
    if (jQuery('#monthly-revenue').length) {
        ...
        function updateChart(period, startDate = null, endDate = null) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Update chart categories if needed
        ...
        // Date range picker with English locale
        ...
        $('#revenue-period').change(function() {
            $('.revenue_heading').html($(this).val().charAt(0).toUpperCase()+ $(this).val().slice(1) +' Revenue');
        ...
        $('#date-range').on('apply.daterangepicker', function(ev, picker) {
            updateChart('custom', picker.startDate.format('YYYY-MM-DD'), picker.endDate.format('YYYY-MM-DD'));
        });
