    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    <div class="datatable-filter ml-auto">
                        <select class="select2 form-control" data-filter="select" id="statusSelect" style="width: 100%">
                            <option value="all" data-route="{{ route('payment.index')}}" selected>{{__('messages.all')}}
                            </option>
                ...
                <div class="col-12 d-flex flex-wrap align-items-center justify-content-end gap-2 mt-3 mb-3">
                    ...
                    <div class="input-group" style="width: auto;">
                        <select class="form-control select2" id="month_filter">
                    ...
                    <div class="input-group" style="width: auto;">
                        <select class="form-control select2" id="year_filter">
                    ...
                    <button id="filter_button" class="btn btn-primary">{{ __('messages.filter') }}</button>
