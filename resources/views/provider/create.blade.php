<x-master-layout>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        ], old('custom_commission_type'), ['class' => 'form-control select2js', 'id' => 'custom_commission_type']) }}
                                    </div>
    ...
    (function($) {
        ...
        // Custom commission validation
        $(document).on('change', '#custom_commission_type, #custom_commission_value', function() {
            var type = $('#custom_commission_type').val();
            var value = $('#custom_commission_value').val();
            
            if ((type && !value) || (!type && value)) {
                if (!type && value) {
                    $('#custom_commission_type').addClass('is-invalid');
                    if (!$('#custom_commission_type').next('.invalid-feedback').length) {
                        $('#custom_commission_type').after('<div class="invalid-feedback">Commission type is required when value is provided.</div>');
                    }
                }
                if (type && !value) {
                    $('#custom_commission_value').addClass('is-invalid');
                    if (!$('#custom_commission_value').next('.invalid-feedback').length) {
                        $('#custom_commission_value').after('<div class="invalid-feedback">Commission value is required when type is selected.</div>');
                    }
                }
            } else {
                $('#custom_commission_type, #custom_commission_value').removeClass('is-invalid');
                $('#custom_commission_type, #custom_commission_value').next('.invalid-feedback').remove();
            }
        });
    })(jQuery);
    </script>
