                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            ...
                            <div class="text-muted">
                                <p class="mb-1">Chamber of Commerce<i class="uil uil-envelope-alt me-1"></i>#: 96527072</p>
                                <p>VAT<i class="uil uil-phone me-1"></i>#: NL867648120B01</p>
                            </div>
                            <div class="text-muted">
                                <p class="mb-1">Choresnap B.V. Beekforel 38 2318 MC, Leiden Nederland</p>
                                <p>Bank number<i class="uil uil-phone me-1"></i>: NL29INGB0112191347</p>
                            </div>
                        </div>
