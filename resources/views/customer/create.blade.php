                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class='form-control select2js' id='user_type' name="user_type">
                                    ...
                                    <option value="{{$value->name}}" data-type="{{$value->id}}"
                                        ...
                                        {{ $value->name == 'user' ? 'customer' : $value->name }}
                                    @endforeach
                                </select>
                            </div>
                            @endif
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('is_email_verified',__('messages.verified').' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                                {{ Form::select('is_email_verified',['1' => __('messages.yes') , '0' => __('messages.no') ],old('status'),[ 'class' =>'form-control select2js','required']) }}
                            </div>
                            <div class="form-group col-md-4">
