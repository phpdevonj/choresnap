<?php return  array (
  ...
  'payment_message_old' => 'Your payment is :status',
  'payment_message' => 'Payment is :status',
  'timezone' => 'Timezone',
  ...
  'my_info' => 'My Info',
  'booking_added_old' => 'Request received for booking #:id.',
  'booking_added' => 'Request sent for :booking_services_name with :provider_name',
  'booking_added_provider' => 'Request received for :booking_services_name from :customer_name',
  'booking_assigned_old' => 'Booking #:id has been accepted. View it in the Bookings tab for details.',
  'booking_assigned' => ':provider_name accepted your :booking_services_name',
  'booking_assigned_provider' => 'You accepted :booking_services_name for :customer_name',
  'booking_transfer' => 'Booking has been transfer to :name',
  'booking_status_update' => 'Booking #:id status has been changed from :from to :to.',
  'quantity' => 'Quantity',
  'booking_id' => 'ID',
  ...
  'service_advanced_payment' => 'Prepayment',
  ...
  'reject_booking' => 'Booking #:id was declined by :name.',
  ...
  'add_booking' => 'Booking Request Sent',
  'assigned_booking' => 'Booking Accepted',
  'transfer_booking' => 'Transfer Booking',
  'update_booking_status' => 'Booking Status Update',
  'payment_message_status' => 'Payment Sent',
  ...
  'refund_cancellation_policy' => 'Schedule and Cancellation Policy',
  ...
  'footer_messages' => 'Find reliable local help for all your household tasks. Fixed prices and instantly arranged via ChoreSnap.',
  ...
  'otp_valid' => 'Verification code successful.',
  ...
  'provider_pay_due' => 'Provider Payout Due',
  ...
  'enter_commission_value' => 'Enter Commission Value',
  'custom_commission_help' => 'Leave both fields empty to use default commission from provider type. Both fields are required if setting custom commission.',
  'stripe_account_details' => 'Stripe Details',
  'stripe_account_id' => 'Stripe Connected Account ID',
  'stripe_verification_status' => 'Stripe Verification Status',
  'stripe_first_name' => 'Stripe First Name',
  'stripe_last_name' => 'Stripe Last Name',
  'stripe_details_help' => 'These values are synced automatically from Stripe once the provider completes onboarding. They are kept for reference when contacting Stripe support.',
  'stripe_name' => 'Stripe Name',
  'stripe_status_verified' => 'Verified',
  'stripe_status_restricted' => 'Restricted',
  'stripe_status_pending' => 'Pending',
  'default_commission' => 'Default Commission',
  'custom_commission_type' => 'Custom Commission Type',
  'custom_commission_value' => 'Custom Commission Value',
  'no_custom_commission' => 'No custom commission set for this provider.',
  'custom_commission_cleared' => 'Custom commission has been cleared successfully.',
  'clear' => 'Clear',
  'add_booking_provider' => 'New Booking Request',
  'payment_message_status_provider' => 'Payment Received',
  'assigned_booking_provider' => 'Booking Accepted',
  'cancel_booking_provider' => 'Booking #:id for :name was cancelled.',
  'opt_send_to_email' => 'Verification code sent to your email.',
  'verify_email' => 'Verify your email',
  'verify_email_text' => 'Enter the verification code below in the app to verify your email address.',
  'code_validity_message' => 'This code is valid for a limited time.',
  'ignore_if_not_requested' => 'If you did not request this code, you can safely ignore this email.',
  'reset_password_title' => 'Reset your password',
  'password_reset_request_message' => 'We received a request to reset your password for your ChoreSnap account.',
  'reset_password' => 'Reset password',
  'link_expiry_message' => 'This link will expire in 60 minutes.',
  'security_notice' => 'Security notice',
  'password_reset_security_notice' => 'If you did not request a password reset, you can safely ignore this email. Your account remains secure.',
  'fallback_link_message' => 'If the button above does not work, copy and paste the following link into your browser:',
  ...
  'provider_address_required_for_my_address' => '"My Address" can only be selected after you\'ve added an address under "Edit profile". Please update your address there and try again.',
);