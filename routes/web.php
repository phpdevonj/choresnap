...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::middleware(['role:admin|demo_admin'])->group(function () {
        Route::get('provider/commission/{id}', [SettingController::class, 'comission'])->name('provider.commission');
        Route::post('provider/commission/{id}', [SettingController::class, 'updateCommission'])->name('provider.commission.update');
        Route::get('provider/commission/{id}/clear', [SettingController::class, 'clearCommission'])->name('provider.commission.clear');
    });
    ...
    Route::get('pages/cookie-policy', [SettingController::class, 'cookiePolicy'])->name('cookie-policy');
    Route::post('cookie-policy-save', [SettingController::class, 'saveCookiePolicy'])->name('cookie-policy-save');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    Route::get('/provider-payout-report/{id}', [ReportController::class, 'providerPayoutReport'])->name('providerPayoutReport');
});


Route::get('/user-data-deletion', [App\Http\Controllers\UserDataDeletionController::class, 'index'])
    ->name('user.data.deletion');

Route::post('/user-data-deletion', [App\Http\Controllers\UserDataDeletionController::class, 'request'])
