...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('booked-services', [API\ServiceController::class, 'bookedService']);
    ...
    Route::post('payment-failed', [API\PaymentController::class, 'markPaymentFailed']);
    ...
    Route::post('send-fcm/{id}', [API\DashboardController::class, 'sendFcm']);

    Route::post('/create-ideal-payment', [API\StripePaymentController::class, 'createIdealPayment']);

    Route::get('/stripe-connect-login', [API\StripePaymentController::class, 'connectLogin']);
