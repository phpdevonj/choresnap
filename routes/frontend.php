...
Route::get('/cookie-policy', [FrontendController::class, 'cookiePolicy'])->name('user.cookie_policy');
Route::get('/payment-policy', [FrontendController::class, 'paymentPolicy'])->name('user.payment_policy');
 Route::get('/data-deletion-request', [FrontendController::class, 'DataDeletion'])->name('user.data_deletion_request');
 Route::get('/refund-cancellation-policy', [FrontendController::class, 'DataDeletion'])->name('user.refund-cancellation-policy');
