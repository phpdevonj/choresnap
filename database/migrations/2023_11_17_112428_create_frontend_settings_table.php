        ...
        if (FrontendSetting::count() === 0) {
            ...
            $settingsData = [
                ...
                [
                    ...
                    'key' => 'section_7',
                    'status' => '1',
                    'value' => '{"section_7":1,"title":"Advanced Solutions And Professional Workflow","description":"Efficient workflow: Plan, execute, collaborate; iterate as needed. Embrace automation, communication, and adaptability for optimal productivity.","url":"https:\/\/www.youtube.com\/watch?v=dQw4w9WgXcQ","subtitle":["Admin To Provider","Provider To Handyman","Handyman To User"],"subdescription":["admin gives the user booking service and then contacts the provider to fulfill the user services successfully.","admin gives the user booking service and then contacts the provider to fulfill the user services successfully.","admin gives the user booking service and then contacts the provider to fulfill the user services successfully."]}',
                ],
                [
                    'type' => 'footer-setting',
                    'key' => 'footer-setting',
