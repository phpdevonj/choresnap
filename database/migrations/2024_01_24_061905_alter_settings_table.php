    ...
    public function up()
    {
            ...
            if(!empty($appsetting)){
                ...
                $appSettingsData[] = [
                    ...
                    'value' => [
                        ...
                        'inquriy_email' => $appsetting->inquriy_email ?? "inquiry@your-url.com",
                        'helpline_number' => $appsetting->helpline_number ?? "+11234567890",
                ...
                $socialMediaData[] = [
                    ...
                    'key' => 'social-media',
                    'value' => [
                        'facebook_url' => $appsetting->facebook_url ?? "https://www.facebook.com/your-url/",
                        'instagram_url' => $appsetting->instagram_url ?? "https://www.instagram.com/your-url",
                        'twitter_url' => $appsetting->twitter_url ?? "https://twitter.com/your-url",
                        'linkedin_url' => $appsetting->linkedin_url ?? "https://www.linkedin.com/company/your-url/",
                        'youtube_url' => $appsetting->youtube_url ?? "https://www.youtube.com/your-url",
                    ],
                ];
                ...
                $siteSetupData['value'] = [
                    ...
                    'playstore_url' => $appsetting->playstore_url ?? "https://play.google.com/store/apps/details?id=your-url",
                    'provider_playstore_url' => $appsetting->provider_playstore_url ?? "https://play.google.com/store/apps/details?id=your-url",
                    ...
                    'site_copyright' => $appsetting->site_copyright ?? "© 2024 All Rights Reserved by your-url Design",
                ];
            }
        }
        ...
        foreach ($appdownloads as $appdownload) {
            if (!empty($appdownload)) {
                $siteSetupData['value']['playstore_url'] = $appdownload->playstore_url ?? "https://play.google.com/store/apps/details?id=your-url";
                $siteSetupData['value']['provider_playstore_url'] = $appdownload->provider_playstore_url ?? "https://play.google.com/store/apps/details?id=your-url";
